...
public class Writer implements IWriter {
    ...
    public RC setConfig(String configFileName){
        BaseGrammar b_g = new WriterGrammar();
        try {
            Syntaksis synt = new Syntaksis(new BufferedReader(new FileReader(configFileName)), logger, b_g.delimiter());
            Writer_Semantic seman = new Writer_Semantic(synt.Result());
            mode = seman.Mode();
        }
